...
const Feedback = () => {
  ...
  const handleFeedback = async (type) => {
    ...
    const payload = {
      liked: type === 'like' ? !isLiked : false,
      disliked: type === 'dislike' ? !isDisliked : false,
    };
  ...
  const handleCommentSubmit = async (e) => {
    ...
    try {
      ...
      // Optionally, clear the comment box after successful submission
      setComment('');
  ...
  return (
    <div className="feedback-container">
      ...
      <button onClick={handleButtonClick} className="feedback-button ml-2">
        <CommentIcon />
      </button>
      {isCommentBoxVisible && (
        <div className="comment-box mt-4">
          <form onSubmit={handleCommentSubmit} className="comment-submit w-60">
